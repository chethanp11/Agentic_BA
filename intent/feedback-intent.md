...
- copilot should treat it as upstream input for design revisions, backlog decisions, and next-iteration scope.
- copilot must not modify it unless explicitly asked.
