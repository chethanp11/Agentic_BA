...
- `.github/copilot-instructions.md` is the constitution for the product being developed.
...
2. Keep the product constitution in `.github/copilot-instructions.md` current.
