...
- `DEV-007` | `2026-04-10` | `no test changes` | This iteration only refined `dev_workflow/`; no `tests/` artifacts were required. | The requested work was limited to workflow file layout and reference cleanup. | `DEV-007` | `AGENTS.md`, `.github/copilot-instructions.md`
- `DEV-008` | `2026-04-10` | `no test changes` | This iteration only changed workflow skill definitions and prompt references; no `tests/` artifacts were required. | The requested work was limited to workflow skill compatibility. | `DEV-008` | `AGENTS.md`, `.github/copilot-instructions.md`
